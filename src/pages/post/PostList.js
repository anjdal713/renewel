...
const PostList = props => {
    ...
    return (
        ...
        <div className = "input-bar">
            ...
            <input type="text" className="text-input" placeholder="내용을 입력해주세요." value={inputValue} onChange={handleTextInput} onKeyPress={handleOnKeyPress}/>
