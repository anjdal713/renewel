      ...
      <ContentContainer>
        ...
        <div>
          ...
          <animated.img src={activity1} alt="한성공학경진대회 이미지" style={{ maxWidth: '100%', marginRight: '20px', marginLeft: '20px',...leftImageProps,}} />
            <div>
              ...
              <BlueH3>대회명 한성공학경진대회</BlueH3><br></br>
        ...
        {selectedButton === "프로그래밍 캠프" && (
          <div>
            ...
            ></iframe><br></br><br></br>
            <h2>행사개요</h2>
            <p>프로그래밍 캠프는 겨울방학을 이용하여 외부 교육 장소에서 4박 5일 합숙하면서 집중적으로 프로그래밍을 학습하는 활동입니다. 학생들은 부족했던 프로그래밍 능력을 향상시킬 수 있고, 학부에 대한 자부심을 느낄 수 있는 자리가 될 것입니다. 또한 학부 교수진이 직접 캠프에 참여하여 전공 교육뿐 아니라 학생들과 소중한 소통의 시간을 가지고 있습니다.</p>
            <br></br><br></br>
            <h2>프로그램 내용</h2>
